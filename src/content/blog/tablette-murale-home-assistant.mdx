...
<figure>
  <img src="/images/tablette-murale/tablette-murale-illustration.jpg" alt="Tablette Home Assistant montée au mur avec dashboard domotique : prise connectée, charge intelligente à 80%, détection de mouvement et suivi en temps réel" style="width: 100%; border-radius: 8px;" />
  <figcaption style="font-size: 0.85rem; color: #6b7280; margin-top: 0.5rem; text-align: center;">La tablette murale en action : prise Sonoff pilotée, charge limitée à 80%, réveil par détection de mouvement, dashboard complet accessible d'un coup d'oeil.</figcaption>
</figure>
