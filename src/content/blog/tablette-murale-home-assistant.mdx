...
![Fiche appareil Fully Kiosk Browser dans Home Assistant : contrôles Screen et Screensaver, capteurs et journal d'activité](/images/tablette-murale/fully-kiosk-ha-appareil.jpg)
*La fiche de l'appareil dans HA expose les contrôles directs (allumage écran, screensaver) ainsi que l'historique des événements.*
