...
![Tablette Xiaomi Redmi Pad SE 11" dans son support mural Route Lisi Designs, affichant le dashboard Home Assistant](/images/tablette-murale/tablette-dashboard.jpg)
*La tablette installée dans son support, vue principale du dashboard : chips météo, présence, caméra rue, contrôles portail et serrures.*
...
![Fiche de l'appareil Fully Kiosk Browser dans Home Assistant : informations, contrôles Screen et Screensaver, capteurs et journal d'activité](/images/tablette-murale/fully-kiosk-ha-appareil.jpg)
*La fiche de l'appareil dans HA regroupe tout : contrôles écran, capteurs batterie, et le journal des événements récents.*
...
![Vue accueil du dashboard Home Assistant sur la tablette murale : sécurité, volets, prévisions météo et contrôles portail](/images/tablette-murale/tablette-vue-accueil.jpg)
*Vue accueil scrollée : alarme, modes de sécurité, volets, prévisions 4 jours, portail, serrures, porte de garage et collecte des poubelles.*

![Vue musique du dashboard Home Assistant : contrôle Spotify en cours, ampli NAD et raccourcis playlists](/images/tablette-murale/tablette-vue-musique.jpg)
*Vue musique : contrôle Spotify actif (lecture en cours à 79 %), ampli NAD et raccourcis vers les playlists fréquentes.*
