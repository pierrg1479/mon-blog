...
title: 'Tablette murale Home Assistant DIY : mon guide complet 2026'
...
- **Tablette** : [Xiaomi Redmi Pad SE 11"](https://www.mi.com/fr/product/redmi-pad-se/) (8 Go / 256 Go), achetée 133,99 € sur AliExpress
- **Support mural** : [Route Lisi Designs](https://routelisidesigns.de/collections/fur-xiaomi-gerate), support spécifique Xiaomi Redmi Pad SE 11", 49,90 €
...
J'ai choisi un support spécifique au modèle plutôt qu'un support universel : le [Wandhalterung Xiaomi Redmi Pad SE 11" de Route Lisi Designs](https://routelisidesigns.de/collections/fur-xiaomi-gerate), un fabricant allemand qui propose des supports fabriqués sur commande pour différents modèles de tablettes.

**49,90 € pour un morceau de plastique, c'est clairement abusé.** Mais le résultat est là : le support est parfaitement ajusté au modèle, la tablette s'enclipse proprement et tient sans bouger. J'ai dû faire quelques petites modifications pour que ça rentre parfaitement dans ma configuration murale, mais rien de bloquant.

Si le budget est une contrainte, des alternatives existent sur [Printables](https://www.printables.com) ou [MakerWorld](https://makerworld.com/fr/models/1316641-xiaomi-redmi-pad-se-wall-mount-clean-smart-home#profileId-1351948) : chercher "Xiaomi Redmi Pad SE 11 wall mount". Il faudra une imprimante 3D ou passer par un service d'impression à la demande.
...
<details>
<summary>Voir le code YAML</summary>
...
<div class="callout callout--warning">
  <p class="callout__content">⚠️ <strong>Mise à jour :</strong> J'ai finalement désactivé la détection de mouvement par caméra frontale. Elle consommait trop rapidement la batterie, même sans être utilisée activement. J'ai basculé sur une automatisation déclenchée par un <strong>capteur de mouvement Zigbee Sonoff</strong> placé dans le couloir : même réactivité, consommation batterie négligeable.</p>
</div>
...
<AffiliateInline
  ...
  title="Détecteur de mouvement Sonoff SNZB-03P"
...
<div class="callout callout--note">
  <p class="callout__title">Lecture du graphique</p>
  <p class="callout__content">L'historique Home Assistant ci-dessous compare la vitesse de décharge selon la méthode de réveil de l'écran. Avec la détection de mouvement par caméra frontale, la batterie passe de 100 % à 30 % en 1 jour et 9 heures, soit -70 % à une moyenne de 2 % par heure. Avec le capteur de mouvement Zigbee Sonoff, la même tranche (70 % à 30 %) prend 2 jours et 8 heures, soit -40 % à seulement 0,7 % par heure en moyenne. Le capteur Zigbee réduit donc la vitesse de décharge de 65 % par rapport à la caméra frontale.</p>
</div>

<figure>
  <img src="/images/tablette-murale/historique-batterie-tablette.jpg" alt="Historique Home Assistant du niveau de batterie de la tablette murale, comparant la décharge avec détection de mouvement par caméra frontale et avec capteur Zigbee Sonoff" style="width: 100%; border-radius: 8px;" />
  <figcaption style="font-size: 0.85rem; color: #6b7280; margin-top: 0.5rem; text-align: center;">Historique du niveau de batterie sur 5 jours : les pentes raides correspondent à la détection par caméra frontale (-2 %/h), les pentes douces au capteur Zigbee Sonoff (-0,7 %/h).</figcaption>
</figure>
...
- [Route Lisi Designs](https://routelisidesigns.de/collections/fur-xiaomi-gerate) : supports muraux spécifiques par modèle de tablette
