...
![Panneau Diagnostic de Fully Kiosk Browser : niveau de batterie 30%, température, mémoire disponible et statut de l'appareil](/images/tablette-murale/fully-kiosk-diagnostic.jpg)
*Le panneau Diagnostic de Fully Kiosk : batterie à 30 %, non branché, 4 Go de mémoire libre sur 8 Go. Tout ce qu'il faut pour surveiller l'état de la tablette depuis HA.*
...
![Panneau Configuration de Fully Kiosk Browser : Motion detection activé, Screen off timer à 60 secondes, Kiosk lock désactivé](/images/tablette-murale/fully-kiosk-configuration.jpg)
*Tous les paramètres clés accessibles depuis la fiche HA : Motion detection activé, extinction écran après 60 s d'inactivité.*
