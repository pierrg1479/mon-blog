...
export const tadoGalleryImages = [
  {
    src: '/images/tado-mode-absent.svg',
    alt: 'Température en mode absent dans l’application Tado avec réglage à 17°C',
    caption: 'Mode absent et préchauffage Tado'
  },
  {
    src: '/images/tado-programmation.svg',
    alt: 'Planning hebdomadaire Tado avec plages de chauffage à 18°C et 19°C',
    caption: 'Programmation hebdomadaire Tado'
  }
];
...
<Gallery type="justified" images={tadoGalleryImages} />
